...
# action_list = ['BODYLOWER','BODYSCRATCH','BODYSHAKE','FEETUP','FOOTUP','HEADING','LYING','MOUNTING','SIT','TAILING','TAILLOW','WALKRUN','MOUNTING']
  ...
  for file in os.listdir(folder_path):
    if file.endswith(".json"):
      ...
      with open(file_path,"r") as json_file:
        ...
        #모든 json file의 annotations data 96 frame 까지만 넣기
        #한 json file의 어노테이션 값 넣을 리스트 생성, 한 파일당 96개의 리스트 생성됨
        # tmp1 =[] #json file 하나
        # tmp2 =[] #json file 하나
